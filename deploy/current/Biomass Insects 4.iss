...
AppId={{5C13A502-8960-4747-AFA9-252BB8F88DA8}
...
Source: {#BuildDir}\Landis.Extension.BiomassInsects-v4.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall ignoreversion
...
#define InfoTxt "Biomass insects 4.txt"
